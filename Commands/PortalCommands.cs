...
namespace AutomationSystem.Commands
{
    ...
    internal class PortalCommands
    {
        ...
        public static void StartPortal(ChatCommandContext ctx, string mapIconName = "POI_BloodMoon_Arena_BloodWars")
        {
            ...
            var user = AutomationSystemCore.EntityManager.GetComponentData<User>(userEntity);
            ...
            var currentPos = AutomationSystemCore.EntityManager.GetComponentData<Translation>(characterEntity).Value;
        ...
        public static void ClearSnapshots(ChatCommandContext ctx)
        {
            ...
            Plugin.Logger?.LogWarning($"Snapshots cleared by admin {AutomationSystemCore.EntityManager.GetComponentData<User>(ctx.Event.SenderUserEntity).CharacterName}");
        }
        ...
        {
            var characterEntity = ctx.Event.SenderCharacterEntity;
            var pos = AutomationSystemCore.EntityManager.GetComponentData<Translation>(characterEntity).Value;
