...
namespace CrowbaneArena
{
    ...
    public static class CrowbaneArenaCore
    {
        ...
        public static World World
        {
            get
            {
                if (_world == null) _world = VRisingCore.ServerWorld;
        ...
        public static EntityManager EntityManager
        {
            get
            {
                if (_entityManager == null) _entityManager = VRisingCore.EntityManager;
        ...
        public static SystemService SystemService
        {
            get
            {
                if (_systemService == null) _systemService = new SystemService(World);
        ...
        public static PrefabCollectionSystem PrefabCollection =>
            World.GetExistingSystemManaged<PrefabCollectionSystem>();

        public static ChunkObjectManager ChunkObjectManager => World.GetExistingSystemManaged<ChunkObjectManager>();

        /// <summary>
        ///     Player service for player management and lookups (static class - no initialization needed).
        /// </summary>
        public static bool PlayerServiceInitialized { get; } = true;

        /// <summary>
        ///     Spawn service for PvP player positioning (static class).
        /// </summary>
        public static bool SpawnServiceInitialized { get; } = true;
        ...
        public static void Initialize()
        {
            ...
            try
            {
                ...
                // Initialize patch service to apply Harmony patches
        ...
        public static string GetStatus()
        {
            ...
            return
                $"Initialized - Services: Player={PlayerServiceInitialized}, System={_systemService != null}, Spawn={SpawnServiceInitialized}";
        }
