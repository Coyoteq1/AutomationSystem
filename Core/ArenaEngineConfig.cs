...
namespace AutomationSystem.Core
{
    ...
    public class ArenaServiceConfig
    {
        ...
        /// </summary>
        public Unity.Mathematics.float3 ArenaCenter { get; set; } = new Unity.Mathematics.float3(1000, 20, 800);
        ...
        /// </summary>
        public Stunlock.Core.PrefabGUID ArenaBloodType { get; set; } = new Stunlock.Core.PrefabGUID(1558171501); // Brute
        ...
        /// </summary>
        public string SnapshotsPath { get; set; } = "config/AutomationSystem_Snapshots.json";
    }
}
