...
namespace AutomationSystem.Automation
{
    /// <summary>
    ...
    public class AutomationTrackingInfo
    {
        ...
        /// <summary>
        /// Gets or sets when tracking ended (null if still active)
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets whether the entity is currently being tracked
        /// </summary>
        public bool IsActive { get; set; } = true;

        /// <summary>
        /// Gets or sets the tracking status (legacy support)
        /// </summary>
    ...
    public class AutomationTrackingStats
    {
        ...
        /// <summary>
        /// Gets or sets the number of completed entities
        /// </summary>
