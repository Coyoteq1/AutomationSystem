...
namespace AutomationSystem.Data.Shared
{
    /// <summary>
    /// Weapon data and utilities shared between AutomationSystem and ICB.core
    /// </summary>
    public static class WeaponInfo
    {
        ...
        public static readonly Dictionary<WeaponType, WeaponData> Weapons = new()
        {
            ...
            { WeaponType.Staff, new("Staff", -1866072901, "Equipment_Weapon_Staff") }
        };
