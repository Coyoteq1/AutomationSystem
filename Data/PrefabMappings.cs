...
{
    /// <summary>
    /// Comprehensive prefab mapping system for AutomationSystem
    /// </summary>
    public static class PrefabMappings
    {
        private static Dictionary<string, Guid> _prefabMap;
        ...
        {
            _prefabMap = new Dictionary<string, Guid>
            {
                ["1059128"] = Guid.Parse("97246fbe-4a67-40a9-bf33-df3caf89c686"),
                ["3759455"] = Guid.Parse("1f6446ab-8f09-417d-83b5-9aa2dff92a19"),
                ["4267150"] = Guid.Parse("5094cbff-f80c-4605-8264-fce8d4c80c93"),
                ["4777796"] = Guid.Parse("a7e02b2f-4171-4257-9148-32387cbff763"),
                ["5164221"] = Guid.Parse("5a4b424f-3775-4322-84a9-a6bfa0804761"),
                ["6059030"] = Guid.Parse("819491b8-fb45-4a33-82c4-1b1395818e40"),
                ["6233001"] = Guid.Parse("c313423f-c120-4970-b079-675be6026690"),
                ["6711686"] = Guid.Parse("2137733c-02af-41c9-8f80-3226422a5fe5"),
                ["7594625"] = Guid.Parse("f9dc7770-8254-41f6-9ef4-02db6801f391"),
                ["8807466"] = Guid.Parse("ed7735e1-218f-4e19-8048-adac907e1e8f")
            };
        ...
        public static bool TryGetGuid(string key, out Guid guid) =>
            _prefabMap.TryGetValue(key, out guid);
    }
}
